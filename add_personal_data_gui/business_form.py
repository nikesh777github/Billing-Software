...
def open_personal_details_form(parent_window, refresh_callback, existing_data=None, business_id=None):
    ...
    fields = ["Business Name", "Addr line 1", "Addr line 2", "Contact", "email", "GSTIN"]
    entries = {}
    ...
    Button(form, text="💾 Save", command=lambda: save_personal_details(entries, form, business_id, refresh_callback)).grid(
