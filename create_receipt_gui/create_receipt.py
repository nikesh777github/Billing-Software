...
def start_billing_app(parent_root=None):
    ...
    Label(frame3, text="HSN:").grid(row=0, column=2)
    Entry(frame3, textvariable=hsn_var, width=10).grid(row=0, column=3)
    Label(frame3, text="Pack:").grid(row=0, column=4)
    Entry(frame3, textvariable=pack_var, width=10).grid(row=0, column=5)
    Label(frame3, text="Batch:").grid(row=0, column=6)
    Entry(frame3, textvariable=batch_var, width=10).grid(row=0, column=7)
    Label(frame3, text="Exp:").grid(row=0, column=8)
    Entry(frame3, textvariable=exp_var, width=10).grid(row=0, column=9)
    Label(frame3, text="MRP:").grid(row=0, column=10)
    Entry(frame3, textvariable=mrp_var, width=10).grid(row=0, column=11)
    Label(frame3, text="Qty:").grid(row=0, column=12)
    Entry(frame3, textvariable=qty_var, width=5).grid(row=0, column=13)
    Label(frame3, text="Rate:").grid(row=0, column=14)
    Entry(frame3, textvariable=rate_var, width=5).grid(row=0, column=15)
    Label(frame3, text="GST:").grid(row=0, column=16)
    Entry(frame3, textvariable=gst_prod_var, width=5).grid(row=0, column=17)
    Button(frame3, text="Add Product", command=add_product).grid(row=0, column=18)
    Button(frame3, text="Remove Selected", command=remove_selected).grid(row=0, column=19)
    Button(frame3, text="🔄", command=on_product_select).grid(row=0, column=20)
    # Product Column view
